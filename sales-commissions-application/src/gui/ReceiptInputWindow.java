...
public class ReceiptInputWindow extends JDialog {
	...
	private Vector <SalesManager> allAgents;
	private  SalesManager agent = new SalesManager();
	private SalesManager selectedAgent = null;
	static ReceiptInputWindow dialog = new ReceiptInputWindow();
	...
	public ReceiptInputWindow(){
		
		initialise();
	}
	
	public void initialise() {
		allAgents = new Vector <SalesManager>();
		...
		getContentPane().add(inputWindowPanel, BorderLayout.CENTER);
				...
				//ADDING THE READ HTML BUTTON
				JButton buttonReadHTML = new JButton("\u0395\u03B9\u03C3\u03B1\u03B3\u03C9\u03B3\u03AE \u03B1\u03C0\u03CC HTML");
				buttonTXTInput.setFont(new Font("Times New Roman", Font.PLAIN, 14));
				buttonTXTInput.setBackground(UIManager.getColor("InternalFrame.borderLight"));
				buttonTXTInput.setFocusPainted(false);
						...
						.addGroup(gl_inputWindowPanel.createSequentialGroup()
							.addGroup(gl_inputWindowPanel.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_inputWindowPanel.createParallelGroup(Alignment.LEADING, false)
									...
									//ADDING THE READ HTML BUTTON
									.addComponent(buttonReadHTML, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
							.addGap(18)
							.addGroup(gl_inputWindowPanel.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_inputWindowPanel.createSequentialGroup()
							...
							.addGroup(gl_inputWindowPanel.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_inputWindowPanel.createSequentialGroup()
									...
									.addGap(42)
									.addComponent(buttonReadHTML, GroupLayout.PREFERRED_SIZE, 48, GroupLayout.PREFERRED_SIZE))
				...
				buttonReadHTML.addActionListener(new ActionListener() {
	...
	private void insertFromTXT(ActionEvent evt){
		...
		try{
			...
			if(agentDuplicate == true){
				JOptionPane.showMessageDialog(null,"Profile Already Loaded");
			...
			JOptionPane.showMessageDialog(null,"TXT File Not Selected");

		}catch (NumberFormatException e){
			JOptionPane.showMessageDialog(null,"TXT File Cannot Be Loaded: Illegal Format");
		}
	...
	private void insertFromXML(ActionEvent evt2){
		...
		try{
			...
			JOptionPane.showMessageDialog(null,"XML File Cannot Be Loaded: Illegal Format");
	...
	private void insertFromHTML(ActionEvent evt3){
		...
		try{
			...
			HTMLInputReader inputFileHMTL = new HTMLInputReader(recieptFileHTML);	
			inputFileHMTL.readFile();
			agent = inputFileHMTL.getAgent();
			...
			JOptionPane.showMessageDialog(null,"HTML File Cannot Be Loaded: Illegal Format");
	...
	private void okButtonPressed(ActionEvent evt) {
		if(agentsList.isSelectionEmpty()){
			JOptionPane.showMessageDialog(null,"Profile Not Selected");

		}
		else{
			ReceiptSelectionDialog sw = new ReceiptSelectionDialog(dialog,selectedAgent,fileTypeFlag);
